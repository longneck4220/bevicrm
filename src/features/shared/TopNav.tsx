    ...
    <Link to="/" className="flex items-center gap-2.5 group">
      ...
      {!compact && (
        <div className="leading-none">
          ...
          <div className="signal-label font-bold text-base font-sans !text-[9px] mt-1" style={{ color: "var(--brand-cyan)" }}>
            Win the next call
          </div>
        </div>
      )}
      ...
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="glass-strong rounded-2xl px-4 py-3 flex items-center justify-between ambient-glow">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/dashboard"
              className="hidden sm:inline-flex text-xs signal-label font-bold text-base font-sans !text-white/80 px-3 py-2 rounded-lg hover:bg-white/5"
            >
              Sign in
            </Link>
            <Link
